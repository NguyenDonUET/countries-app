    ...
    <div className='min-h-full text-base mt-8'>
      <div className='container'>
        ...
        <div className='flex gap-8 md:gap-16 flex-col justify-center md:flex-row md:items-center md:justify-between'>
          <img src={png} alt={common} className='basis-1/2 w-ful h-full' />
          {/* Info */}
          <div className='flex flex-col gap-4 text-black dark:text-white basis-1/2'>
            <h3 className='font-extrabold md:text-xl text-2xl'>{official}</h3>
            <div className='flex flex-col gap-2'>
              <div className='country-info'>
                <CountryInfo title={'Native Name'} content={official} />
                <CountryInfo
                  title={'Population'}
                  content={
                    population === 0
                ...
                <CountryInfo title={'Region'} content={region} />
                <CountryInfo
                  title={'Sub Region'}
                ...
                <CountryInfo
                  title={'Capital'}
                  content={capital ? capital[0] : 'updating...'}
                />
              </div>
              <div className='country-info mt-4'>
                ...
                />
                <CountryInfo title={'Currencies'} content={currencies} />
                <CountryInfo title={'Languages'} content={languages} />
              </div>
            </div>
